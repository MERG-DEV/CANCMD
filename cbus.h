...
/*
 ...
 CBUS Command Station - CBUS routine definitions 
...
/*
void can_opc(BYTE opc);
void can_opcnn(BYTE opc, WORD Node_id);
void can_tx_nn(WORD Node_id, BYTE dlc_val);
void can_tx(BYTE dlc_val);
void can_bus_on(void);
void can_debug1(BYTE status);
void can_debug_event(WORD Node_id, BYTE *debug_data);
*/
